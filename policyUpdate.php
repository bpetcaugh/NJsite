	...
	<div class="wrapper">
		...
		<div id="content">
			...
			<div class="body-wrapper">
				<!-- Your code goes here -->
				<?php showAlert(); ?>
                <h1>Modify a Policy</h1>
                <p>Use this form to modify an existing policy.</p>
...
<div class='btn-group'>
	<a class="btn btn-success" href="policyUpdate.php?download=1" style="visibility:<?php if (isset($_SESSION['policy'])) {echo 'visible';} else {echo 'hidden;position:absolute';} ?>;">Download Policy</a>  
	...
	<a class="btn btn-primary" href="policyUpdate.php?reset=1">Reset Search</a>
</div>
...
<form  style="margin-bottom: 20px; visibility:<?php if (isset($_SESSION['policy'])) {echo 'visible';} else {echo 'hidden;position:absolute';} ?>;" class="needs-validation" method="post" action="policyUpdate.php" novalidate>
  ...
  <div class="form-group">
    <label for="suggestionsComments">Describe Modification to Policy</label>
