	...
	<div class="wrapper">
		...
		<div id="content">
			...
			<div class="body-wrapper">
				<!-- Your code goes here -->
				<?php showAlert(); ?>
                <h1>Obsolete a Policy</h1>
                <p>This process will move old policies to a separate folder on the server, and will NOT actually remove them.
                    They will no longer show up in search results on the main webpage.
				</p>
...
<div class='btn-group'>
	<a class="btn btn-success" href="policyDelete.php?download=1" style="visibility:<?php if (isset($_SESSION['policy'])) {echo 'visible';} else {echo 'hidden;position:absolute';} ?>;">Download Policy</a>  
	<!--<a class="btn btn-danger" href="policyDelete.php?delete=1" style="visibility:<?php if (isset($_SESSION['policy'])) {echo 'visible';} else {echo 'hidden;position:absolute';} ?>;">Delete Policy</a>  -->
	<a class="btn btn-primary" href="policyDelete.php?reset=1">Reset Search</a>
</div>

<br /><br />

<form  style="margin-bottom: 20px; visibility:<?php if (isset($_SESSION['policy'])) {echo 'visible';} else {echo 'hidden;position:absolute';} ?>;" class="needs-validation" method="post" action="policyDelete.php" novalidate>

  <div class="form-group">
    <label for="suggestionsComments">Reason Policy is Obsolete</label>
